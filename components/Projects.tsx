  ...
  const projectsData: Project[] = [
    {
      ...
      visualComponent: (
        <svg
          viewBox="0 0 400 300"
          className="w-full h-full text-[var(--color-sand)]"
          fill="none"
        >
          {/* Background grid */}
          ...
          />
          <path
            d="M 50 65 L 140 65 M 50 85 L 120 85 M 50 105 L 130 105"
            stroke="currentColor"
            strokeWidth="2"
            strokeOpacity="0.4"
            strokeLinecap="round"
          ...
          <text
            ...
            y="153"
            fill="currentColor"
            className="font-mono text-[9px] font-bold opacity-60"
          >
            DOC_CHUNK.bin
          </text>
          ...
          {/* Connection pathway */}
          <path
            d="M 160 130 C 200 130, 200 150, 240 150"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeOpacity="0.5"
            strokeDasharray="5,5"
          ...
          <text
            ...
            y="105"
            fill="currentColor"
            className="font-syne text-[8px] tracking-widest font-bold opacity-40"
          >
            VECTOR_SEARCH
          </text>
        </svg>
    ...
    },
    {
      ...
      visualComponent: (
        ...
        >
          ...
          />
          <path
            d="M 201 178 L 211 168 L 221 173 L 236 160"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
      ...
      visualComponent: (
        ...
        >
          ...
          >
            ...
            {/* Bell icon outline */}
            <path
              d="M 25 22 C 22 22, 21 25, 21 28 L 29 28 C 29 25, 28 22, 25 22 Z M 20 29 L 30 29 L 29 32 L 21 32 Z"
              stroke="currentColor"
              strokeWidth="1"
            />
            <text
              ...
              y="27"
              fill="currentColor"
              className="font-syne text-[8px] font-bold tracking-wider"
            >
              WATER_ALERT
            </text>
            <text
              ...
              y="42"
              fill="currentColor"
              className="font-inter text-[8px] text-zinc-400"
            >
              Flow detected! Alert dispatched.
            </text>
          </g>
          ...
          <text
            ...
            y="110"
            fill="currentColor"
            className="font-syne text-[10px] tracking-widest font-bold opacity-30"
          >
            MONITOR_DASHBOARD
          </text>
        </svg>
    ...
    },
    {
      ...
      visualComponent: (
        ...
        >
          ...
          />
          <path
            d="M 65 100 L 155 100 M 65 115 L 125 115"
            stroke="currentColor"
            strokeWidth="2"
            strokeOpacity="0.3"
            strokeLinecap="round"
          ...
          <text
            ...
            y="160"
            fill="currentColor"
            className="font-syne text-[10px] font-bold opacity-80"
          >
            Tech Meetup 2026
          </text>
          <text
            ...
            y="178"
            fill="currentColor"
            className="font-inter text-[8px] text-zinc-500"
          >
            Aug 31 // 6:00 PM
          </text>
          <rect
        ...
        >
          ...
          >
            ...
            <p className="font-inter text-zinc-400 text-base md:text-lg leading-relaxed">
              A curated selection of core engineering projects showcasing
              scalable systems design, full-stack applications, and AI
              integrations. Built with performance, clean schemas, and robust
            ...
            >
              ...
              >
                <motion.div
                  ...
                  className="flex items-center space-x-3 text-zinc-500 font-inter text-xs font-semibold uppercase tracking-widest"
                >
                ...
                <motion.h3
                  variants={projectChildVariants}
                  className="font-syne font-bold text-4xl md:text-5xl tracking-tight text-white"
                >
                  {project.name}
                </motion.h3>
                ...
                <motion.p
                  variants={projectChildVariants}
                  className="font-inter text-zinc-400 text-sm md:text-base leading-relaxed"
                >
                  {project.description}
                </motion.p>
